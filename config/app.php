...
return [
	...
	*/
	...
	|--------------------------------------------------------------------------
	|
	| Base url to where /api.php is located, do not include a trailing slash
	|
	*/
	'mediawiki_api_base' => env('MEDIAWIKI_API_BASE', 'https://login.wikivy.com/w'),
